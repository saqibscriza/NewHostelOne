...
export const verifyOtpApi = async (data) => {
  try {
    ...
    console.log(
      "Token being sent:",
      data.token?.startsWith("Bearer") ? data.token : `Bearer ${data.token}`,
    );
...
export const createOrderPayment = async (data) => {
  try {
    axios.defaults.headers.common["Authorization"] = getToken();
    const res = await axios.post(`${Domain}/payment/create-order`, data);
    return res.data;
  } catch (error) {
    // console.log("GET FEE STUDENT DETAILS ERROR 👉", error);
    return null;
...
export const verifyPayment = async (data) => {
  try {
    axios.defaults.headers.common["Authorization"] = getToken();
    const res = await axios.post(`${Domain}/payment/verify`, data);
    return res.data;
  } catch (error) {
    // console.log("GET FEE STUDENT DETAILS ERROR 👉", error);
    return null;
...
export const updateStockApi = async (stockId, params) => {
  try {
    axios.defaults.headers.common["Authorization"] = getToken();
    const res = await axios.put(
      `${Domain}/inventory/stock/update/${stockId}`,
      null,
      {
        params,
      },
...
export const getAllAmenitiesApi = async () => {
  ...
  try {
    ...
    const res = await axios.get(`${Domain}/amenities/all`);
...
export const addStudentApi = async (data) => {
  try {
    ...
    console.log("ADD STUDENT ERROR 👉", error?.response?.data || error);
...
export const getDashboardAdminApi = async () => {
  try {
    ...
    const res = await axios.get(`${Domain}/dashboard/admin`);
...
export const getAdminProfileApi = async () => {
  try {
    ...
    const res = await axios.get(`${Domain}/admin/user/profile`);
...
export const changePasswordApi = async (data) => {
  try {
    ...
    const res = await axios.post(`${Domain}/login/changeMyPassword`, null, {
      params: {
