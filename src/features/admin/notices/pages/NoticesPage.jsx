    ...
    <div className="space-y-6 bg-background min-h-screen p-6">
      ...
      {filteredNotices?.length === 0 ? (
        <DefaultTable
          ...
          description="There are currently no notices available. Create a new notice to get started."
          buttonText="Add New Notice"
          onButtonClick={() => navigate("/admin/notices/create")}
          height="400px"
        />
      ) : (
                ...
                <div className="space-y-4 p-5">
                  ...
                  <div>
                    ...
                    <div className="mt-3 relative">
                      <p className="text-sm leading-6 text-muted-foreground overflow-hidden pr-8 [display:-webkit-box] [-webkit-line-clamp:3] [-webkit-box-orient:vertical] break-all">
                      ...
                      <div className="absolute bottom-0 right-0 group/tooltip bg-card pl-1">
                        ...
                        <div className="absolute bottom-full right-0 mb-4 opacity-0 invisible group-hover/tooltip:visible group-hover/tooltip:opacity-100 transition-all duration-200 w-[340px] max-h-[260px] overflow-y-auto rounded-2xl bg-black text-white p-5 text-sm leading-7 break-all shadow-2xl z-[9999]">
