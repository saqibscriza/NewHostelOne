    ...
    const fetchLocation = async () => {
      ...
      try {
        ...
        if (
          ...
          setError("pinCode", {
            type: "manual",
            message: locationData?.message || "Invalid PinCode",
          });
        ...
        setError("pinCode", {
          type: "manual",
          message: error?.response?.data?.message || "Invalid PinCode",
        });
        setValue("country", "");
        setValue("state", "");
        setValue("city", "");
    ...
    >
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gray-100 text-gray-400 flex items-center justify-center text-sm font-semibold">
              2
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-20 h-20 rounded-full border border-dashed border-gray-300 bg-gray-50 flex items-center justify-center shrink-0 overflow-hidden">
              {profilePhoto && profilePhoto.length > 0 ? (
                ...
                />
              ) : savedAdminInfo?.profilePhoto &&
                savedAdminInfo.profilePhoto.length > 0 ? (
                <img
                  src={URL.createObjectURL(savedAdminInfo.profilePhoto[0])}
                  alt="Profile"
                  className="w-full h-full object-cover"
                />
              ) : (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register("email", {
                  ...
                  pattern: {
                    value:
                      /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.(com|in|org|net|co\.in)$/,
